...
public interface IUmaAuthorizationService
{
    ...
    Task<HttpResult<List<UmaPermissionsResponse>, ErrorRepresentation>> CheckPermissions( string userAccessToken, string resource, List<string> scopes, IReadOnlyDictionary<string, List<string>> claims, CancellationToken ct );
}
