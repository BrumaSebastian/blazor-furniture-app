...
using System;
namespace BlazorFurniture.Infrastructure.Admin.Realms.Item.Users.Count
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::BlazorFurniture.Infrastructure.Admin.Realms.Item.Users.Count.CountRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<int?> GetAsync(Action<RequestConfiguration<global::BlazorFurniture.Infrastructure.Admin.Realms.Item.Users.Count.CountRequestBuilder.CountRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<int?> GetAsync(Action<RequestConfiguration<global::BlazorFurniture.Infrastructure.Admin.Realms.Item.Users.Count.CountRequestBuilder.CountRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::BlazorFurniture.Infrastructure.Admin.Realms.Item.Users.Count.CountRequestBuilder.CountRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::BlazorFurniture.Infrastructure.Admin.Realms.Item.Users.Count.CountRequestBuilder.CountRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::BlazorFurniture.Infrastructure.Admin.Realms.Item.Users.Count.CountRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::BlazorFurniture.Infrastructure.Admin.Realms.Item.Users.Count.CountRequestBuilder WithUrl(string rawUrl)
        {
            return new global::BlazorFurniture.Infrastructure.Admin.Realms.Item.Users.Count.CountRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// It can be called in three different ways. 1. Don’t specify any criteria and pass {@code null}. The number of all users within that realm will be returned. &lt;p&gt; 2. If {@code search} is specified other criteria such as {@code last} will be ignored even though you set them. The {@code search} string will be matched against the first and last name, the username and the email of a user. &lt;p&gt; 3. If {@code search} is unspecified but any of {@code last}, {@code first}, {@code email} or {@code username} those criteria are matched against their respective fields on a user entity. Combined with a logical and.
        /// </summary>
